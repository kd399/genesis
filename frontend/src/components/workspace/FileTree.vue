...
<template>
  <div class="h-full flex flex-col">
    ...
    <!-- ── FILES section ───────────────────────────────────────── -->
    <div class="px-3 py-2 border-b flex items-center justify-between shrink-0 bg-secondary" style="height: 36px;">
    ...
    <div class="flex-1 overflow-y-auto py-1 min-h-0 bg-secondary">
      <!-- Empty state -->
    ...
    <!-- ── SNAPSHOTS section ───────────────────────────────────── -->
    <div class="border-t shrink-0 bg-secondary">
      <!-- Collapsible header -->
      <button
